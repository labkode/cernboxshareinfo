...
func (dc *DimensionCompany) Insert(db XODB) error {
	...
	res, err := db.Exec(sqlstr, dc.Company)
	if err != nil {
		return err
	}
...
func (dc *DimensionCompany) Update(db XODB) error {
	...
	// run query
	XOLog(sqlstr, dc.Company, dc.ID)
	_, err = db.Exec(sqlstr, dc.Company, dc.ID)
	return err
}
...
func (dc *DimensionCompany) Delete(db XODB) error {
	...
	// sql query
	const sqlstr = `DELETE FROM mydb.dimension_company WHERE id = ?`

	// run query
	XOLog(sqlstr, dc.ID)
	_, err = db.Exec(sqlstr, dc.ID)
	if err != nil {
		return err
	}
...
// DimensionCompanyByID retrieves a row from 'mydb.dimension_company' as a DimensionCompany.
//
// Generated from index 'dimension_company_id_pkey'.
func DimensionCompanyByID(db XODB, id int) (*DimensionCompany, error) {
	var err error
	...
	err = db.QueryRow(sqlstr, id).Scan(&dc.ID, &dc.Company)
	if err != nil {
		return nil, err
	}
